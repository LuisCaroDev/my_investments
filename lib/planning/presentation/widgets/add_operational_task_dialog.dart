...
class AddOperationalTaskDialog extends StatefulWidget {
  final bool isProjectLevel;
  final String? initialName;

  const AddOperationalTaskDialog({
    super.key,
  ...
  @override
  State<AddOperationalTaskDialog> createState() =>
      _AddOperationalTaskDialogState();
}

class _AddOperationalTaskDialogState extends State<AddOperationalTaskDialog> {
