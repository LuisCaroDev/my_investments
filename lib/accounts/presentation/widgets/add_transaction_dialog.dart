...
class AddTransactionDialog extends StatefulWidget {
  final List<domain.OperationalTask> availableCategories;
...
class _AddTransactionDialogState extends State<AddTransactionDialog> {
  ...
  String? _selectedOperationalTaskId;
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              GhostButton(
                onPressed: () {
                  setState(() => _selectedOperationalTaskId = null);
                  Navigator.of(ctx).pop();
                },
                child: Row(
                  children: [
              ...
              if (activityCategories.isNotEmpty) ...[
                ...
                ...activityCategories.map(
                  (cat) => GhostButton(
                    onPressed: () {
                      setState(() => _selectedOperationalTaskId = cat.id);
                      Navigator.of(ctx).pop();
                    },
                    child: Row(
                      children: [
                        Expanded(child: Text(cat.name)),
                        if (_selectedOperationalTaskId == cat.id)
                          const Icon(RadixIcons.check, size: 14),
                      ],
                    ),
                  ),
